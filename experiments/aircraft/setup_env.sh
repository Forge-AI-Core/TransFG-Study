...
python -m ipykernel install --user --name=$VENV_NAME --display-name "TransFG Aircraft"
...
echo "  Jupyter 커널    : 'TransFG Aircraft' 선택"
echo "  PyCharm         : Interpreter를 ./$VENV_NAME/bin/python 으로 설정"
echo ""
echo "📂 다음 단계 (README.md 참고):"
echo "  1) 데이터 준비:"
echo "     mkdir -p FGVC-Aircraft"
echo "     wget https://www.robots.ox.ac.uk/~vgg/data/fgvc-aircraft/archives/fgvc-aircraft-2013b.tar.gz"
echo "     tar -xzf fgvc-aircraft-2013b.tar.gz -C ./FGVC-Aircraft"
echo ""
echo "  2) 사전학습 가중치 준비 (Phase 1 - 둘 중 하나):"
...
echo "     # CUB 학습 결과 (Phase 1 메인 실험)"
echo "     # → master 브랜치 TransFG_CUB200.ipynb로 학습 후 결과 체크포인트를"
echo "     #   pretrained/cub_pretrained.bin 으로 복사"
echo ""
echo "  3) 노트북 실행:"
echo "     jupyter notebook TransFG_Aircraft_New.ipynb"
echo "=========================================="
